...
- `solutions/NNNN-problem-slug.sql` — one file per problem, named by LeetCode problem number (zero-padded) and slug.
...
| 1978 | [Employees Whose Manager Left the Company](https://leetcode.com/problems/employees-whose-manager-left-the-company/) | Easy | Subquery, NOT IN | [SQL](solutions/1978-employees-whose-manager-left-the-company.sql) |
